...
namespace LogisticManagementProject
{
    public partial class Trip : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                query = "insert into Trip values('"+ TripID.Text +"','" + Startlocation.Text + "','" + Destination.Text + "','" + Departuretime.Text + "')";
                OleDbConnection Con = getCon();
                OleDbCommand Cmd = new OleDbCommand();
                Cmd.Connection = Con;
                Con.Open();
        ...
        {
            // TODO: This line of code loads data into the 'logistic_ManagementDataSet13.Trip' table. You can move, or remove it, as needed.
            this.tripTableAdapter.Fill(this.logistic_ManagementDataSet13.Trip);
