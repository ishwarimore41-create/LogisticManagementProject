...
namespace LogisticManagementProject
{
    public partial class Inventory2 : Form
    {
        ...
        private void Save_Click(object sender, EventArgs e)
        {
            try
            {
                query = "insert into Inventory2 values'"+ ProductID.Text +"','" + Productname.Text + "','" + Quantity.Text + "')";
                OleDbConnection Con = getCon();
                OleDbCommand Cmd = new OleDbCommand();
                Cmd.Connection = Con;
                Con.Open();
        ...
        {
            // TODO: This line of code loads data into the 'logistic_ManagementDataSet19.Inventory' table. You can move, or remove it, as needed.
            this.inventoryTableAdapter.Fill(this.logistic_ManagementDataSet19.Inventory);
