...
namespace LogisticManagementProject {
    ...
    public partial class employeeDataSet : global::System.Data.DataSet {
        ...
        public partial class employeeDataTable : global::System.Data.TypedTableBase<employeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public employeeRow AddemployeeRow(string empname, int contactno, string address) {
...
namespace LogisticManagementProject.employeeDataSetTableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `employee` WHERE ((`ID` = ?) AND ((? = 1 AND `empname` IS NULL) OR (`" +
                "empname` = ?)) AND ((? = 1 AND `contactno` IS NULL) OR (`contactno` = ?)) AND ((" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `employee` (`empname`, `contactno`, `address`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `employee` SET `empname` = ?, `contactno` = ?, `address` = ? WHERE ((`ID` " +
                "= ?) AND ((? = 1 AND `empname` IS NULL) OR (`empname` = ?)) AND ((? = 1 AND `con" +
                "tactno` IS NULL) OR (`contactno` = ?)) AND ((? = 1 AND `address` IS NULL) OR (`a" +
                "ddress` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LogisticManagementProject.Properties.Settings.Default.employeeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, empname, contactno, address FROM employee";
